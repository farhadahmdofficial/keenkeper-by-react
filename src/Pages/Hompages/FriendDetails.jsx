            ...
            <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 pb-10">
                ...
                <div className="md:col-span-8 lg:col-span-9 space-y-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 relative shadow-sm">
                        <button className="absolute right-6 top-6 text-blue-600 text-xs font-bold hover:underline">
                            Edit
                        </button>
...
//             const newEntry = {
//                 name: selectedFriend.name,
//                 type: type, // এখানে 'Call', 'Text' বা 'Video' আসবে
//                 date: new Date().toLocaleString(), // অটোমেটিক বর্তমান সময়
//                 id: Date.now()
//             };

//         settimeline([...timeline, selectedFriend,newEntry])
